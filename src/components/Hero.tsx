  ...
  return (
    <section className="relative min-h-screen bg-hero-gradient overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-brand-blue/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }}></div>
        <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-64 h-64 bg-brand-green/10 rounded-full blur-2xl"></div>
      </div>
      ...
      <div className="relative section-container pt-20 pb-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <p className="text-xl md:text-2xl text-gray-300 mb-8 max-w-3xl mx-auto leading-relaxed animate-fade-in-up" style={{ animationDelay: '0.4s' }}>
            Descubra as estratégias secretas que os <strong className="text-brand-green">influenciadores de sucesso</strong> usam para viralizar, 
            criar conteúdo de alto impacto e transformar seguidores em <strong className="text-brand-green">clientes fiéis</strong>
          </p>

          {/* Video Section */}
          <div className="relative max-w-2xl mx-auto mb-12 animate-fade-in-up" style={{ animationDelay: '0.6s' }}>
            <div className="aspect-video bg-gradient-to-br from-dark-card to-dark-bg rounded-2xl border border-white/10 flex items-center justify-center group cursor-pointer hover-scale">
              <div className="flex items-center space-x-3 text-white group-hover:text-brand-green transition-colors">
                <div className="w-16 h-16 bg-brand-green rounded-full flex items-center justify-center animate-pulse-glow">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12 animate-fade-in-up" style={{ animationDelay: '0.8s' }}>
            ...
            <div className="glass-card p-6 text-center hover-scale">
              <TrendingUp className="w-8 h-8 text-brand-green mx-auto mb-3" />
              <div className="text-3xl font-bold text-white">10x</div>
              <div className="text-gray-400">Mais Engajamento</div>
            </div>
            <div className="glass-card p-6 text-center hover-scale">
              <DollarSign className="w-8 h-8 text-brand-purple mx-auto mb-3" />
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '1s' }}>
            <Button 
              size="lg" 
              className="bg-cta-gradient hover:shadow-lg hover:shadow-brand-green/25 text-white font-bold px-12 py-6 text-lg rounded-full transition-all duration-300 hover:scale-105 animate-pulse-glow"
            >
              QUERO VIRALIZAR AGORA
            </Button>
            <p className="text-sm text-gray-400 mt-4">🔥 Mais de 1.000 pessoas se inscreveram hoje</p>
          </div>
        </div>
      </div>
    </section>
