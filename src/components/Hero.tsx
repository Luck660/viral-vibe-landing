  ...
  return (
    <section className="relative min-h-screen bg-hero-gradient overflow-hidden">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-brand-red/20 rounded-full blur-3xl animate-float" style={{ animationDelay: '1s' }}></div>
      ...
      <div className="relative section-container pt-20 pb-16">
        <div className="text-center max-w-4xl mx-auto">
          ...
          <div className="animate-fade-in-up" style={{ animationDelay: '1s' }}>
            <Button 
              size="lg" 
              className="bg-cta-gradient hover:shadow-lg hover:shadow-brand-red/25 text-white font-bold px-12 py-6 text-lg rounded-full transition-all duration-300 hover:scale-105 animate-pulse-glow"
            >
